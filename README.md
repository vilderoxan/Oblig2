...
Sjekker først for nullverdier og setter indekskontroll til true: hvor indeks = antall er lovlig. 
Sjekker tilfellet hvor indeks == antall og når antall er null og ellers (ingen noder skal flyttes). 
